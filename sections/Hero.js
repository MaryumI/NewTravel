    ...
    <>
      <section className='hero'>
        <div className='container'>
          ...
          <h1 className='hero-title'>Travelers' Best Choice</h1>

          <div className='sub-heading'>
            <TitleSm title='DISCOVER' /> <span>.</span>
            <TitleSm title='TRIPS' /> <span>.</span>
            <TitleSm title='COMMUNITY' />
          </div>
        </div>
      </section>
      <section className='hero-sec'>
        <div className='container'>
          <div className='heading-title'>
            <Title title='The last Travel agency you ll ever need' />
